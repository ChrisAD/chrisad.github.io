---
title: "My Qualys attack surface management study, covered by SecurityBrief"
...
You can read SecurityBrief's write-up [here](https://securitybrief.com.au/story/qualys-study-calls-for-unified-attack-surface-management). iTWire also covered it, framing the shift well in [New SANS survey finds attack surface management is evolving from severity scores to business-aligned risk operations](https://itwire.com/guest-articles/guest-research/new-sans-survey-finds-attack-surface-management-is-evolving-from-severity-scores-to-business-aligned-risk-operations).
